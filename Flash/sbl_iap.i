...
#line 17 "Drivers\\sbl_iap.c"
#line 1 "Drivers\\sbl_config.h"
...
#line 95 "Drivers\\sbl_config.h"



 
#line 129 "Drivers\\sbl_config.h"

                          
#line 18 "Drivers\\sbl_iap.c"



const uint32_t sector_start_map[30] = {0x00000000,             0x00001000,0x00002000,0x00003000,0x00004000,0x00005000,      0x00006000,0x00007000,0x00008000,0x00009000,0x0000A000,     0x0000B000,0x0000C000,0x0000D000,0x0000E000,0x0000F000, 0x00010000,0x00018000,0x00020000,0x00028000,0x00030000, 0x00038000,0x00040000,0x00048000,0x00050000,0x00058000, 0x00060000,0x00068000,0x00070000,0x00078000					 };
#line 28 "Drivers\\sbl_iap.c"

const uint32_t sector_end_map[30] = {0x00000FFF,0x00001FFF,    0x00002FFF,0x00003FFF,0x00004FFF,0x00005FFF,0x00006FFF,0x00007FFF,   0x00008FFF,0x00009FFF,0x0000AFFF,0x0000BFFF,0x0000CFFF,             0x0000DFFF,0x0000EFFF,0x0000FFFF,0x00017FFF,0x0001FFFF,           0x00027FFF,0x0002FFFF,0x00037FFF,0x0003FFFF,0x00047FFF,           0x0004FFFF,0x00057FFF,0x0005FFFF,0x00067FFF,                         0x0006FFFF,0x00077FFF,0x0007FFFF										 };
#line 36 "Drivers\\sbl_iap.c"
...
uint32_t write_flash(uint32_t * dst, uint8_t * src, uint32_t no_of_bytes)
{
  uint32_t i;
	...
	if( byte_ctr == 256)
	{
      ...
      write_data((uint32_t)flash_address,(uint32_t *)flash_buf,256);
      if(result_table[0] != 0)
      {
        while(1);  
      }
...
void execute_user_code(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (sector_start_map[2]) & 0x1FFFFF80;

	boot_jump((sector_start_map[2]));
}
...
void check_isp_entry_pin(void)
{
    if( (*(volatile uint32_t *)0x2009C034) & (0x1<<20) )
	{
	    execute_user_code();
	}
	else
