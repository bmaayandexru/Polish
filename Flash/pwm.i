...
void PWM_Init( uint32_t cycle )
{
	...
	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |= (01 << 10);	

	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->TCR = 0x00000002;			
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PR = 0x00;				
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MCR = (1 << 1);			

	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR0 = cycle;				
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->LER |= (1 << 0);			
}
...
void PWM_Start(void)
{
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->PCR = (1 << 13) | (1 << 14);		
...
{			
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->MR6 = offset;
	((LPC_PWM_TypeDef *) ((0x40000000UL) + 0x18000) )->LER |=  (1 << 6);			
